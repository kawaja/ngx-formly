...
export class FormlyJsonschema {
  ...
  // TODO: it's not really clear what this function is doing? Does it have a side-effect
  // of modifying or re-creating the visible fields in the DOM? It seems to be causing
  // the deletion of fields in 'if' clauses
